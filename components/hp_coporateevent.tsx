...
const images = [
  { src: "/hp_imgframe.png", alt: '', text: "Coporate Event" },
  { src: "/hp_imgframe.png", alt: '', text: "Business Event" },
  { src: "/hp_imgframe.png", alt: '', text: "Rental Event" },
  { src: "/hp_imgframe.png", alt: '', text: "Work Event" },
  { src: "/hp_imgframe.png", alt: '', text: "Laptop Event" },
  { src: "/hp_imgframe.png", alt: '', text: "Hello Event" },
];
