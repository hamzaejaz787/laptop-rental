  ...
  return (
    <div className="md:pl-20 md:pr-10 pl-5 pr-5 grid md:pt-10 pt-3 md:grid-cols-[35%,65%]">
      <div className="flex-col md:justify-start justify-center">
        <div className="flex md:flex-col md:justify-start md:items-start justify-center items-center gap-4">
          <span className="font-Poppins bg-primary-red px-2 font-bold rounded-sm text-white uppercase">
            Rent Event
          </span>
        ...
        <div>
          ...
          <p className="text-gray md:text-[15px] text-[5px] font-Poppins font-#595959 md:text-start text-center md:pb-5 pb-2">
            ...
            sed do eiusmod tempor incididunt ut labore ipsum dolor sit amet,
            consectetur adipiscing elit, sed do eiusmod tempor incididunt
            adipiscing Lorem ipsum dolor sit amet, consectetur adipiscing elit,
