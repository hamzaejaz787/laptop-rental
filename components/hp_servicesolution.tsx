  ...
  return (
    <div className="flex flex-col md:pl-20 pl-3 md:pr-20 pr-3 md:pt-10 pt-5 md:pb-10 pb-5">
      <div className="grid grid-cols-2 md:grid-cols-2 gap-5 justify-center">
        <div className="flex flex-col">
          <div className="md:w-48 w-32">
            <p
              className="font-Barlow font-semibold text-[10px] md:text-[16px] uppercase text-primary-red"
              style={{ borderBottom: "2px dashed #D61837" }}
            >
              services we provide
            </p>
          </div>
          <p className="font-Barlow font-bold text-[20px] md:text-[28px]">
            Event Services Solution
          </p>
        </div>
        <div className="flex gap-3">
          <div className="bg-primary-red w-1 h-full md:w-3 md:h-[70px]"></div>
          <p className="font-Poppins font-normal text-[5px] md:text-[12px] align-middle">
      ...
      <div className="flex-col relative mt-5">
        <div className="bg-primary-red w-full h-[1px] md:h-[2px]">
          <div className="flex gap-[60px] md:gap-[250px] px-8 md:px-32 pb-5"></div>
        </div>
      </div>
        ...
        {[
          ...
          <div key={index} className="flex flex-col items-center p-3 relative">
            ...
            <Image
              ...
              height={100}
              width={100}
              className="h-[20px] w-[20px] md:h-[60px] md:w-[65px] mb-2"
            />
            <p className="font-bold font-Barlow text-[6px] md:text-[14px] text-center">
              {service.title}
            </p>
            <p className="font-normal font-Poppins text-[4px] md:text-[10px] text-center">
              {service.text}
            </p>
          </div>
        ))}
