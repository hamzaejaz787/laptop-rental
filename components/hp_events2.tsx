      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 flex flex-col md:items-start items-center justify-center md:pl-20 pl-5 pb-3 md:pb-10 pt-3 md:pt-0">
          <div className="flex items-center gap-1 ">
            ...
            <div className="flex-col md:items-start items-center md:justify-start justify-center">
              <div className=" text-white font-Barlow">
                <p className="md:text-[50px] text-[18px] md:font-[900px]  font-bold md:text-start text-center">
                  EVENT RENTALS
                </p>
                <p className="md:text-[35px] text-[14px] md:font-[500px] md:text-start text-center font-semibold">
                  PRODUCT SERVICES
                </p>
              </div>
          ...
          <div className="flex text-white font-Poppins md:text-[16px] text-center font-normal text-[8px] pt-0 md:text-left md:pb-3 pb-2">
            ...
            conference, trade show, or business event, having access
          </div>
          <Button
            asChild
            className="w-20 md:w-40 h-9 rounded-sm md:h-12 font-Poppins border text-black border-none bg-white hover:bg-primary-red focus-within:bg-primary-red hover:text-white focus-within:text-white transition-all duration-200 capitalize text-[9px] md:text-[18px]"
          >
