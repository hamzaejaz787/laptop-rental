...
const ContactsOptions = () => {
  return (
    <div className="text-white gap-6 w-full flex flex-row justify-center items-center lg:flex-col">
      <div className="flex w-[33%] flex-col justify-center items-center">
        ...
        <p className="text-center font-semibold">+92 333 123 1234</p>
      </div>
      <div className="flex w-[33%] flex-col justify-center items-center">
        <svg
          xmlns="http://www.w3.org/2000/svg"
        ...
        <p className="text-center font-semibold">laptoprental@gmail.com</p>
      </div>
      <div className="flex w-[33%] flex-col justify-center items-center">
        <svg
          xmlns="http://www.w3.org/2000/svg"
