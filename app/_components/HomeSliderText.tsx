...
const HomeSliderText = ({
  ...
  return (
    <div className="z-10 relative text-center md:text-left space-y-3 md:space-y-4 content-center h-full px-8 md:pl-20">
      ...
      <h1 className="text-white lg:max-w-xl text-center md:text-left text-5xl md:text-7xl uppercase font-Barlow font-bold relative before:bg-white md:before:block md:before:absolute before:top-0 before:bottom-0 before:w-1 before:left-0 md:pl-8">
        {title}{" "}
      </h1>
